...
function Feedback75RoutineBegin(snapshot) {
  return function () {
    ...
    psychoJS.experiment.addData('Target_On', target.tStartRefresh);
    psychoJS.experiment.addData('Target_OFF', target.tStopRefresh);
    trialNumLoop100 = (trialNumLoop100 + 1);
...
function Feedback50RoutineBegin(snapshot) {
  return function () {
    ...
    if (_pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11))) {
        ...
        congDur.push((target.tStopRefresh - target.tStartRefresh));
        incongDur.push(NaN);
        Loop50.addData("50 incongruentTrialDuration", incongDur[trialNumLoop100]);
        Loop50.addData("50 congruentTrialDuration", congDur[trialNumLoop100]);
    } else {
        if ((! _pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11)))) {
            trialCongruency = "incongruent";
            incongDur.push((target.tStopRefresh - target.tStartRefresh));
...
function FeedbackNeutralRoutineBegin(snapshot) {
  return function () {
    ...
    if (_pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11))) {
        ...
        congDur.push((target.tStopRefresh - target.tStartRefresh));
        incongDur.push(NaN);
        LoopNeutral.addData("Neutral incongruentTrialDuration", incongDur[trialNumLoop100]);
        LoopNeutral.addData("Neutral congruentTrialDuration", congDur[trialNumLoop100]);
    } else {
        if ((! _pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11)))) {
            trialCongruency = "incongruent";
            incongDur.push((target.tStopRefresh - target.tStartRefresh));
