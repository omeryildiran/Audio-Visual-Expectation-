...
function denemeLoopBegin(denemeLoopScheduler) {
  ...
  deneme = new TrialHandler({
    ...
    trialList: TrialHandler.importConditions(psychoJS.serverManager, 'congruent100.xlsx', '0:5'),
...
function Loop100LoopBegin(Loop100LoopScheduler) {
  ...
  Loop100 = new TrialHandler({
    ...
    //trialList: TrialHandler.importConditions(psychoJS.serverManager, 'congruent100.xlsx', '0:1'),
...
function Loop75LoopBegin(Loop75LoopScheduler) {
  ...
  Loop75 = new TrialHandler({
    ...
    //trialList: TrialHandler.importConditions(psychoJS.serverManager, 'congruent75.xlsx', '207:208'),
...
function Loop50LoopBegin(Loop50LoopScheduler) {
  ...
  Loop50 = new TrialHandler({
    ...
    //trialList: TrialHandler.importConditions(psychoJS.serverManager, 'congruent50.xlsx', '0:2'),
...
function LoopNeutralLoopBegin(LoopNeutralLoopScheduler) {
  ...
  LoopNeutral = new TrialHandler({
    ...
    //trialList: TrialHandler.importConditions(psychoJS.serverManager, 'c_neutral.xlsx', '0:2'),
...
function Validity100TrialRoutineEachFrame(snapshot) {
  return function () {
    ...
    if (t >= 2.0 && target.status === PsychoJS.Status.NOT_STARTED) {
      ...
      target.tStart =target.frameNStart*frameDur ;
      target.setAutoDraw(true);
    }

 if (target.status === PsychoJS.Status.STARTED && frameN >= (target.frameNStart + currentDur)) {       
    //target.tStop = t; 
        target.frameNStop = frameN;
        target.tStop=target.frameNStop*frameDur ;
...
function Feedback100RoutineBegin(snapshot) {
  return function () {
    ...
    if (_pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11))) {
        ...
        congDur.push((target.tStop - target.tStart));
        incongDur.push(NaN);
        deneme.addData("100 incongruentTrialDuration", incongDur[trialNumLoop100]);
        deneme.addData("100 congruentTrialDuration", congDur[trialNumLoop100]);
    } else {
        if ((! _pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11)))) {
            trialCongruency = "incongruent";
            incongDur.push((target.tStop - target.tStart));
            congDur.push(NaN);
            deneme.addData("100 congruentTrialDuration", congDur[trialNumLoop100]);
            deneme.addData("100 incongruentTrialDuration", incongDur[trialNumLoop100]);
        }
    ...
    psychoJS.experiment.addData('Target_On', target.tStart);
    psychoJS.experiment.addData('Target_OFF', target.tStop);
...
function Validity75TrialRoutineEachFrame(snapshot) {
 ...
 if (target_2.status === PsychoJS.Status.STARTED && frameN >= (target_2.frameNStart + currentDur)) {       
        //target_2.tStop = t; 
...
function Feedback75RoutineBegin(snapshot) {
  return function () {
    ...
    if (_pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11))) {
        trialCongruency = "congruent";
        congDur.push((target_2.tStopRefresh - target_2.tStartRefresh));
        incongDur.push(NaN);
        Loop75.addData("75 Valid incongruentTrialDuration", incongDur[trialNumLoop100]);
        Loop75.addData("75 Valid congruentTrialDuration", congDur[trialNumLoop100]);
    } else {
        if ((! _pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11)))) {
            trialCongruency = "incongruent";
            incongDur.push((target_2.tStopRefresh - target_2.tStartRefresh));
            congDur.push(NaN);
            Loop75.addData("75 Valid congruentTrialDuration", congDur[trialNumLoop100]);
            Loop75.addData("75 Valid incongruentTrialDuration", incongDur[trialNumLoop100]);
        }
    ...
    psychoJS.experiment.addData('Target_On', target_2.tStartRefresh);
    psychoJS.experiment.addData('Target_OFF', target_2.tStopRefresh);
    trialNumLoop100 = (trialNumLoop100 + 1);
...
function Validity50TrialRoutineEachFrame(snapshot) {
 ...
 if (target_3.status === PsychoJS.Status.STARTED && frameN >= (target_3.frameNStart + currentDur)) {       
        //target_3.tStop = t; 
...
function Feedback50RoutineBegin(snapshot) {
  return function () {
    ...
    if (_pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11))) {
        trialCongruency = "congruent";
        congDur.push((target_3.tStopRefresh - target_3.tStartRefresh));
        incongDur.push(NaN);
        Loop50.addData("50Valid incongruentTrialDuration", incongDur[trialNumLoop100]);
        Loop50.addData("50Valid congruentTrialDuration", congDur[trialNumLoop100]);
    } else {
        if ((! _pj.in_es6(cueFile.slice(7, 11), targetFile.slice(7, 11)))) {
            trialCongruency = "incongruent";
            incongDur.push((target_3.tStopRefresh - target_3.tStartRefresh));
            congDur.push(NaN);
            Loop50.addData("50Valid congruentTrialDuration", congDur[trialNumLoop100]);
            Loop50.addData("50Valid incongruentTrialDuration", incongDur[trialNumLoop100]);
        }
    ...
    psychoJS.experiment.addData('Target_On', target_3.tStartRefresh);
    psychoJS.experiment.addData('Target_OFF', target_3.tStopRefresh);
    trialNumLoop100 = (trialNumLoop100 + 1);
...
function NeutralTrialRoutineEachFrame(snapshot) {
  return function () {
    ...
    // *target_4* updates
    if (t >= 0.2 && target_4.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
 ...
 if (target_4.status === PsychoJS.Status.STARTED && frameN >= (target_4.frameNStart + currentDur)) {       
        //target_4.tStop = t; 
    ...
    if (fixation_4.status === PsychoJS.Status.STARTED && frameN >= (fixation_4.frameNStart + (expInfo['frameRate']*0.2)+currentDur+durMask+0.0001)) {
...
function ResponseNeutralRoutineEnd(snapshot) {
  return function () {
    ...
    response_4.stop();
    if ((targetPos[1] > 0)) {
        if ((response_4.keys === "right")) {
            feedback = "Do\u011fru";
            accuracy.push(1);
            LoopNeutral.addData("Accuracy", 1);
        } else {
            if ((response_4.keys === "left")) {
                feedback = "Yanl\u0131\u015f";
                accuracy.push(0);
...
function FeedbackNeutralRoutineBegin(snapshot) {
  return function () {
    ...
    congDur.push((target_4.tStopRefresh - target_4.tStartRefresh));

    LoopNeutral.addData("Neutral_Target_Dur", congDur[trialNumLoop100]);
    LoopNeutral.addData("isCongruent", trialCongruency);
    psychoJS.experiment.addData('Target_On', target_4.tStartRefresh);
    psychoJS.experiment.addData('Target_OFF', target_4.tStopRefresh);
    trialNumLoop100 = (trialNumLoop100 + 1);
