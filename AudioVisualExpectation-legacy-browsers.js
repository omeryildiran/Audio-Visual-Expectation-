...
function Instruction_DeneyRoutineBegin(snapshot) {
  return function () {
    ...
    Instruction_DeneyComponents.forEach( function(thisComponent) {
...
function Validity100TrialRoutineBegin(snapshot) {
  return function () {
    ...
    Validity100TrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Response100RoutineBegin(snapshot) {
  return function () {
    ...
    Response100Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback100RoutineBegin(snapshot) {
  return function () {
    ...
    Feedback100Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction100RoutineBegin(snapshot) {
  return function () {
    ...
    Instruction100Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction75RoutineBegin(snapshot) {
  return function () {
    ...
    Instruction75Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Validity75TrialRoutineBegin(snapshot) {
  return function () {
    ...
    Validity75TrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Response75RoutineBegin(snapshot) {
  return function () {
    ...
    Response75Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback75RoutineBegin(snapshot) {
  return function () {
    ...
    Feedback75Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruction50RoutineBegin(snapshot) {
  return function () {
    ...
    Instruction50Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Validity50TrialRoutineBegin(snapshot) {
  return function () {
    ...
    Validity50TrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Response50RoutineBegin(snapshot) {
  return function () {
    ...
    Response50Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Feedback50RoutineBegin(snapshot) {
  return function () {
    ...
    Feedback50Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function InstructionNeutralRoutineBegin(snapshot) {
  return function () {
    ...
    InstructionNeutralComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NeutralTrialRoutineBegin(snapshot) {
  return function () {
    ...
    NeutralTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ResponseNeutralRoutineBegin(snapshot) {
  return function () {
    ...
    ResponseNeutralComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function FeedbackNeutralRoutineBegin(snapshot) {
  return function () {
    ...
    FeedbackNeutralComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_of_expRoutineBegin(snapshot) {
  return function () {
    ...
    end_of_expComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
